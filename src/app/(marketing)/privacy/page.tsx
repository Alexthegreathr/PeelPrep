...
const INTRO = (
  <p>
    ...
    means handling genuinely sensitive information — your résumé, the roles you
    are pursuing, your practice answers, and how interviews turn out. This
    policy explains what we collect, how we use it, and the controls you have.
    It is written for the current beta; we will update the effective date and,
    where changes are material, ask you to review them again.
  </p>
);
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        PeelPrep grounds this content in the information you supply and clearly
        labels anything that comes from general knowledge rather than a source
        you provided. It does not fabricate citations, invent your experiences,
        or infer protected or sensitive characteristics about interviewers — we
        use only public professional context to help you prepare respectfully.
      </p>
    ),
  },
  {
    ...
    body: (
      <ul className="list-disc space-y-1.5 pl-5">
        ...
        <li>
          Uploaded files live in private storage and are reachable only through
          short-lived signed links issued after a server-side ownership check.
        </li>
        <li>
    ...
    body: (
      <ul className="list-disc space-y-1.5 pl-5">
        ...
        <li>
          ...
          (removing its generated content and uploaded materials tied to it) or
          delete your entire account. Account deletion removes your stored files
          and personal records; anonymized security-log entries may be retained
          as required.
        </li>
        <li>
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        needed to provide the service. When you delete content or your account,
        it is removed rather than archived. Temporary export files expire
        automatically. Stripe retains its own billing records as legally
        required.
      </p>
    ),
  },
